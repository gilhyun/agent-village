...
export const DEFAULT_AGENTS: Omit<Agent, "x" | "y" | "targetX" | "targetY" | "destination">[] = [
  {
    ...
    emoji: "📊",
    color: "#6366f1",
    personality: "온체인 데이터 분석가. 고래 지갑 추적, DEX 볼륨, TVL 변화를 분석한다. 데이터 없이는 투자 안 한다. 숫자로 말하는 스타일.",
    speed: 2.4,
    state: "walking",
    talkingTo: null,
    homeId: "house-minsu",
  ...
  },
  {
    ...
    emoji: "🎯",
    color: "#ec4899",
    personality: "밈코인 헌터. 트위터/텔레그램에서 초기 밈코인을 발굴하는 감각이 뛰어나다. 100배 코인을 찾는 게 목표. 감으로 투자하지만 성공률이 높다.",
    speed: 1.8,
    state: "walking",
    talkingTo: null,
    homeId: "house-jieun",
  ...
  },
  {
    ...
    emoji: "🐋",
    color: "#14b8a6",
    personality: "디파이(DeFi) 전문가. 이자 농사, LP, 스테이킹, 브릿지 전략에 능숙하다. 리스크 관리를 중시하고 안정적인 수익을 추구한다.",
    speed: 2.8,
    state: "walking",
    talkingTo: null,
    homeId: "house-junho",
  ...
  },
  {
    ...
    emoji: "📈",
    color: "#f59e0b",
    personality: "차트 기술적 분석가. RSI, MACD, 볼린저밴드, 피보나치를 활용한다. '차트는 거짓말을 하지 않는다'가 신념. 매매 타이밍에 집착한다.",
    speed: 2.0,
    state: "walking",
    talkingTo: null,
    homeId: "house-hana",
  ...
  },
  {
    ...
    emoji: "💎",
    color: "#ef4444",
    personality: "장기 투자자(HODLER). 비트코인 맥시멀리스트. '결국 비트코인이 답이다'를 외친다. 단타를 경멸하고 존버를 신성시한다. 매크로 경제에 관심이 많다.",
    speed: 2.2,
    state: "walking",
    talkingTo: null,
